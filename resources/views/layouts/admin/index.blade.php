...
<head>
    ...
    {{-- <title>@yield('metaTitle') - werwigo</title> --}}
...
<body>
    ...
    {{-- Header --}}
    @role('super-admin')
        <div class="max-w-[86rem] mx-auto border shadow-md px-5 py-2 mt-5 rounded-lg">
            <ul class="flex flex-col gap-3 lg:flex-row">
                {{-- <li>
                <a href="{{ route('admin.dashboard') }}" @class([
                    'text-[#000000]' => request()->routeIs('admin.dashboard'),
                    'hover:underline',
                ])>Dashbard</a>
            </li> --}}
                <li>
                    <a href="{{ route('admin.hotels.index') }}" @class([
                        'text-[#000000]' =>
                            ...
                            request()->routeIs('admin.hotel-categories.*') ||
                            request()->routeIs('admin.hotel-tags.*') ||
                            // request()->routeIs('admin.hotel-services.*'),
                            'hover:underline',
                    ])>Properties</a>
                </li>
                <li>
                    <a href="{{ route('admin.users.index') }}" @class([
                        'text-[#000000]' => request()->routeIs('admin.users.*'),
                        'hover:underline',
                    ])>Users</a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.faqs.index') }}" @class([
                        'text-[#000000]' => request()->routeIs('admin.faqs.*'),
                        'hover:underline',
                    ])>Support</a>
                </li>
                <li>
                    <a href="{{ route('admin.terms-of-service.index') }}" @class([
                        'text-[#000000]' => request()->routeIs('admin.terms-of-service.index'),
                        'hover:underline',
                    ])>Terms of service</a>
                </li>
                <li>
                    <a href="{{ route('admin.profile.index') }}" @class([
                        'text-[#000000]' => request()->routeIs('admin.profile.index'),
                        'hover:underline',
                    ])>Profile</a>
                </li>
                <li>
    ...
    {{-- @if (!$__env->yieldContent('hideFooter', false))
        ...
        <nav class="fixed bottom-0 w-full bg-white lg:hidden z-[9999]">
            <ul class="flex items-center justify-around shadow-xl ">
                ...
                <li>
                    <a href="{{ route('home') }}"
                        ...
                        <span @class([
                            'text-xs text-[#7b7a81]',
                            '!text-[#000000] font-semibold' => request()->routeIs('home'),
                        ])>{{ __('Vibes') }}</span>
                ...
                <li>
                    <a href="{{ route('favorites') }}"
                        ...
                        <span @class([
                            'text-xs text-[#7b7a81]',
                            '!text-[#000000] font-semibold' => request()->routeIs('favorites'),
                        ])>"{{ __('Saved') }}</span>
