...
<body style="padding-bottom: 11rem !important;">
    ...
    <!-- Main section -->
    <div class="container main-container !tw-max-w-3xl" style="margin-top:120px; ">
        <div
            class="tw-[&>p]:text-gray-500 tw-[&>ul>li]:text-gray-500 tw-no-tailwindcss-base tw-rounded-xl tw-border tw-px-8 tw-py-5 tw-shadow-xl">
